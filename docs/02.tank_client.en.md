...
2. **ProudNet Unity Package** - Available from ProudNet installation
3. **Completed Tank Server** - From the previous server setup documentation

### ProudNet Unity Package Location
The ProudNet Unity package should be available at:
```
...
#### Step 1: Import ProudNet Unity Package
Import the ProudNet Unity package to add networking capabilities:
...
2. Navigate to `tank_unity_client_proudnet_sample.unitypackage`
3. Select the package file and click **"Open"**
4. In the import dialog, select **"All"** to import all components
5. Click **"Import"** to add ProudNet to the project

![ProudNet Unity Package Import](img/image_003.png)
*ProudNet Unity package import dialog - Select "All" and click "Import" to add ProudNet networking components*
